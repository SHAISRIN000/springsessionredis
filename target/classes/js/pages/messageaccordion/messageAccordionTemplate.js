		...
		if (userAccess.options.length > 1) {
			...
			for (var j = 0; j < userAccess.options.length; j++) {
				...
				if (mountingBode.indexOf("IA") != -1) {
					var _idVal = stateCd + "IAMessageTable";
					channelsAccordion.push(_react2.default.createElement(
						'div',
						{ key: mountingBode, 'data-trigger': 'Independent Agent', 'data-channel-count': chanelCnt, 'data-state-cd': stateCd, 'data-company-cd': dataCompanyCd, 'data-department': department, 'data-mounting-island': _idVal },
						_react2.default.createElement(
							'div',
							{ className: 'stateMessageSubBody' },
							_react2.default.createElement(
								'table',
								{ id: _idVal, className: 'display' },
								_react2.default.createElement(
									'thead',
									null,
									_react2.default.createElement(
				...
				if (mountingBode.indexOf("HP") != -1) {
					var _idVal2 = stateCd + "HPMessageTable";
					channelsAccordion.push(_react2.default.createElement(
						'div',
						{ key: mountingBode, 'data-trigger': 'Captive', 'data-channel-count': chanelCnt, 'data-state-cd': stateCd, 'data-company-cd': dataCompanyCd, 'data-department': department, 'data-mounting-island': _idVal2 },
						_react2.default.createElement(
							'div',
							{ className: 'stateMessageSubBody' },
							_react2.default.createElement(
								'table',
								{ id: _idVal2, className: 'display' },
								_react2.default.createElement(
									'thead',
									null,
									_react2.default.createElement(
			...
			return _react2.default.createElement(
				'div',
				{ key: stateCd, 'data-trigger': stateDesc, ref: 'bingo', 'data-state-cd': stateCd, 'data-company-cd': dataCompanyCd, 'data-department': department, 'data-mounting-island': dataMountingIsland },
				_react2.default.createElement(
					_Accordion2.default,
					null,
					channelsAccordion
			...
			for (var j = 0; j < userAccess.options.length; j++) {
				...
				if (mountingBode.indexOf("IA") != -1) {
					...
					channelsAccordion.push(_react2.default.createElement(
						'div',
						{ key: mountingBode, 'data-state-cd': stateCd, 'data-company-cd': dataCompanyCd, 'data-department': department, 'data-mounting-island': idVal },
						_react2.default.createElement(
							'div',
							{ className: 'stateMessageSubBody' },
							_react2.default.createElement(
								'table',
								{ id: idVal, className: 'display' },
								_react2.default.createElement(
									'thead',
									null,
									_react2.default.createElement(
			...
			return _react2.default.createElement(
				'div',
				{ key: stateCd, 'data-trigger': stateDesc, 'data-channel-count': _chanelCnt, ref: 'bingo', 'data-state-cd': stateCd, 'data-company-cd': dataCompanyCd, 'data-department': department, 'data-mounting-island': idVal },
				channelsAccordion
			);
		}
...
//Message Accordion
_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('messageApp'));
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(9),B=__webpack_require__(10),C=__webpack_require__(1),ba=__webpack_require__(11),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(14),ia=__webpack_require__(15),D=__webpack_require__(4);
    ...
    var nodes = this.props.children.map(function (node, index) {
      ...
      return _react2.default.createElement(
        _Collapsible2.default,
        {
          ...
          channelCount: node.props['data-channel-count'] },
        node
      );
    });
    return _react2.default.createElement(
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.open !== this.props.open) {
        if (this.props.open === true) {
          ...
          if (this.props.trigger === 'Independent Agent' || this.props.trigger === 'Captive' || 1 == this.props.channelCount && (this.props.trigger === 'Connecticut' || this.props.trigger === 'New Jersey' || this.props.trigger === 'Pennsylvania' || this.props.trigger === 'Massachussets' || this.props.trigger === 'New Hampshire')) {
            ...
            var mountingIsland = this.props.mountingIsland;
            ...
            messageContentRequest.done(function (data, status, jqXHR) {
              if (data != null) {
                ...
                for (var i = 0; i < data.length; i++) {
                  var tr = $('<tr/>');
                  tr.append("<td> <p style=\"float: left; width: 600px; padding: 2px 0px; margin-top: 14px;\">" + "<a href=\"#\" id=\"messageTitle_" + data[i].id + "\" class=\"messageLink\">" + data[i].title + "</a></p> </td>");
                  tr.append("<td><p style=\"float: right; padding: 2px 0px;width: 120px; color: #0099cc !important; margin-top: 14px;\">" + "<span id=\"messageDate_" + i + "\"style=\"float: right;\">" + $.datepicker.formatDate('mm/dd/yy', new Date(data[i].effDate)) + "</span></p>" + "<div id=\"messageDetail_" + data[i].id + "\" class=\"hidden\">" + data[i].detail + "</div></td></tr>");
