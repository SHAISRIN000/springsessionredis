...
var App = createReactClass({
	...
	buildSections: function buildSections(userData) {
		var sections = userData.map(this.buildSection);
		return sections;
	},

	buildSection: function buildSection(userAccess, index) {
		...
		return _react2.default.createElement('div', { key: stateCd, 'data-trigger': stateDesc, ref: 'bingo', 'data-state-cd': stateCd, 'data-company-cd': dataCompanyCd, 'data-department': department, 'data-mounting-island': dataMountingIsland });
	},
...
var m=__webpack_require__(10),n=__webpack_require__(6),p=__webpack_require__(2),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(12),B=__webpack_require__(13),C=__webpack_require__(2),ba=__webpack_require__(14),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ia=__webpack_require__(18),D=__webpack_require__(6);
...
var _Collapsible = __webpack_require__(34);
...
var _PrimaryPanels = __webpack_require__(35);

var _PrimaryPanels2 = _interopRequireDefault(_PrimaryPanels);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_PrimaryPanels2.default, { department: this.props.department, stateCd: this.props.stateCd, mountingIsland: this.props.mountingIsland,
              panelClosed: this.state.isClosed, companyCd: this.props.companyCd })
          )
        )
      );
    }
...
Collapsible.propTypes = {
  stateCd: _propTypes2.default.string,
  companyCd: _propTypes2.default.string,
  mountingIsland: _propTypes2.default.string,
...
var _PanelContentItems = __webpack_require__(36);

var _PanelContentItems2 = _interopRequireDefault(_PanelContentItems);
...
var PrimaryPanels = createReactClass({
		...
		if (this.props.panelClosed != prevProps.panelClosed) {
			if (!this.props.panelClosed) {
				...
				var primaryPageRequest = $.ajax({
					...
					beforeSend: function beforeSend(status, xhr) {
						blockUser();
					},
	...
	render: function render() {
		...
		for (var cont = 0; cont < mountingArr.length; cont++) {
		...
		var nodes = mountingArr.map(function (node, index) {
			var conObj = _this.state.data[node];
			var contentItem = [];
			...
			for (var key in conObj) {
				if (key === 'contentItem') {
					contentItem = conObj[key];
				}
				if (key === 'department') {
					panelPrimaryProps.department = conObj[key];
				}
				if (key === 'stateCd') {
					panelPrimaryProps.stateCd = conObj[key];
				}
				if (key === 'channelCd') {
					panelPrimaryProps.channelCd = conObj[key];
				}
			}
			//console.log('contentItem = '+contentItem+'primary Panel Props = '+JSON.stringify(panelPrimaryProps));
			if (_this.state.data && _this.state.data[node] && contentItem.length > 1) {
				return _react2.default.createElement(_PanelContentItems2.default, { key: index, ndxPanel: index, mountingIsland: node, panelContents: contentItem, panelInfo: panelPrimaryProps });
			}
			return null;
		});
	...
	buildHeaderInfo: function buildHeaderInfo() {

		var marginRPanel = { width: "45%" };
		var marginLPanel = { width: "45%", marginLeft: "5%" };
		...
		if (this.state.mountingContanier.indexOf('IA') != -1 && this.state.mountingContanier.indexOf('HP') != -1) {
			return _react2.default.createElement(
				'div',
				{ className: 'headerMainPanel' },
				_react2.default.createElement(
					'div',
					{ className: 'col-md-6 headerLeft text-center', style: marginRPanel },
					'Independent Agent'
				),
				_react2.default.createElement(
					'div',
					{ className: 'col-md-6 headerRight', style: marginLPanel },
					'Captive'
				)
			);
...
PrimaryPanels.propTypes = {
	...
	mountingIsland: _propTypes2.default.string,
	department: _propTypes2.default.string,
	primaryRequestUrl: _propTypes2.default.string,
	panelClosed: _propTypes2.default.bool
};
...
var _ContentItem = __webpack_require__(37);
...
var PanelContentItems = function (_React$Component) {
	_inherits(PanelContentItems, _React$Component);

	function PanelContentItems(props) {
		_classCallCheck(this, PanelContentItems);

		return _possibleConstructorReturn(this, (PanelContentItems.__proto__ || Object.getPrototypeOf(PanelContentItems)).call(this, props));
	}

	_createClass(PanelContentItems, [{
		key: 'getMountingNodes',
		value: function getMountingNodes(mountingIsland, panelContents) {
			var innerKey = 'IA';
			...
			if (this.props.ndxPanel == 0) {
				indents.push(_react2.default.createElement(
					'div',
					{ className: 'panel panel-default col-md-6', style: marginRPanel, key: innerKey, ref: mountingIsland, id: mountingIsland },
					contents
				));
			} else {
				indents.push(_react2.default.createElement(
					'div',
					{ className: 'panel panel-default col-md-6', style: marginLPanel, key: innerKey, ref: mountingIsland, id: mountingIsland },
					contents
				));
			}
			return indents;
		...
		value: function renderContentItem(contentItemsList) {
			var _this2 = this;

			if (contentItemsList.length > 0) {
				var listStyle = 'list-group-item';
				var contentItems = contentItemsList.map(function (contentItem, index) {
					return _react2.default.createElement(
						'li',
						{ key: index },
						_react2.default.createElement(_ContentItem2.default, { content: contentItem, panelInfo: _this2.props.panelInfo })
					);
				});
				return _react2.default.createElement(
					'div',
...
PanelContentItems.propTypes = {
	mountingIsland: _propTypes2.default.string,
	panelContents: _propTypes2.default.arrayOf(_propTypes2.default.object)
};
...
exports.default = PanelContentItems;
...
var _SecondaryPage = __webpack_require__(38);

var _SecondaryPage2 = _interopRequireDefault(_SecondaryPage);
...
var ContentItem = function (_React$Component) {
	...
	_createClass(ContentItem, [{
		...
		key: 'processHeader',
		value: function processHeader(contentItem) {
			var headerStyle = {
				fontFamily: "Arial",
				fontSize: "13px",
				fontWeight: "500",
			...
			return _react2.default.createElement(
				'div',
				{ className: 'w_containerHeading' },
				contentItem.displayValue
			);
		}
	}, {
		key: 'processSecondaryPages',
		value: function processSecondaryPages(contentItem) {
			var _secondaryPageStyle;

			var secondaryPageStyle = (_secondaryPageStyle = {
				fontFamily: "Arial",
				fontSize: "11px",
				fontWeight: "regular",
				fontStyle: "normal",
				...
				cursor: "pointer"
			}, _defineProperty(_secondaryPageStyle, 'color', "blue"), _defineProperty(_secondaryPageStyle, 'textDecoration', "none"), _secondaryPageStyle);
			//return (<div style={secondaryPageStyle}><SecondaryPage secondaryItem={contentItem} panelInfo={this.props.panelInfo}/></div>)
			return _react2.default.createElement(
				'div',
				{ className: 'w_label_1 w_label_2ndLvl' },
				_react2.default.createElement(_SecondaryPage2.default, { secondaryItem: contentItem, panelInfo: this.props.panelInfo })
			);
		}
	}, {
		key: 'processCategory',
		value: function processCategory(contentItem) {
			var categoryStyle = {};
			return _react2.default.createElement(
				'div',
				null,
		...
		key: 'processUploadedDocument',
		value: function processUploadedDocument(contentItem) {
			var _uploadedDocumentStyl;

			var uploadedDocumentStyle = (_uploadedDocumentStyl = {
				fontFamily: "Arial",
				fontSize: "11px",
				fontWeight: "regular",
				fontStyle: "normal",
				...
				margin: "5px 0px 3px 10px",
				cursor: "pointer"
			}, _defineProperty(_uploadedDocumentStyl, 'color', "blue"), _defineProperty(_uploadedDocumentStyl, 'textDecoration', "none"), _uploadedDocumentStyl);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'a',
					{ target: ContentItem.defaultProps.newWin, href: ContentItem.defaultProps.vignetteUrl + contentItem.url },
					contentItem.displayValue
				)
			);
		}
		...
		key: 'processUrl',
		value: function processUrl(contentItem) {
			var _urlStyle;

			var urlStyle = (_urlStyle = {
				fontFamily: "Arial",
				fontSize: "11px",
				fontWeight: "regular",
				fontStyle: "normal",
				...
				margin: "5px 0px 3px 10px",
				cursor: "pointer"
			}, _defineProperty(_urlStyle, 'color', "blue"), _defineProperty(_urlStyle, 'textDecoration', "none"), _urlStyle);
...
ContentItem.propTypes = {
	vignetteUrl: _propTypes2.default.string,
	newWin: _propTypes2.default.string
};
...
var _SecondaryPageModal = __webpack_require__(39);

var _SecondaryPageModal2 = _interopRequireDefault(_SecondaryPageModal);
...
var SecondaryPage = function (_React$Component) {
	_inherits(SecondaryPage, _React$Component);

	function SecondaryPage(props) {
		_classCallCheck(this, SecondaryPage);

		var _this = _possibleConstructorReturn(this, (SecondaryPage.__proto__ || Object.getPrototypeOf(SecondaryPage)).call(this, props));
		...
		_this.showSecondaryPageDataModal = _this.showSecondaryPageDataModal.bind(_this);
		_this.hideSecondaryPageDataModal = _this.hideSecondaryPageDataModal.bind(_this);
		return _this;
	}

	_createClass(SecondaryPage, [{
		key: 'showSecondaryPageDataModal',
		value: function showSecondaryPageDataModal(secPageId, secPageDisplayName) {
			this.setState({
				showPopUp: true,
		...
		key: 'hideSecondaryPageDataModal',
		value: function hideSecondaryPageDataModal(secPageId, secPageDisplayName) {
			this.setState({
				showPopUp: false,
				secondaryPgId: secPageId,
				secondaryPgName: secPageDisplayName
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ onClick: function onClick() {
							_this2.showSecondaryPageDataModal(_this2.props.secondaryItem.secPageId, _this2.props.secondaryItem.displayValue);
						}, 'data-toggle': 'modal', 'data-target': '#myModal' },
					_react2.default.createElement(
						'a',
						{ href: '#' },
						this.props.secondaryItem.displayValue
					)
				),
				this.state.showPopUp ? _react2.default.createElement(_SecondaryPageModal2.default, { show: this.state.showPopUp, onClose: function onClose() {
						_this2.hideSecondaryPageDataModal(_this2.props.secondaryItem.secPageId, _this2.props.secondaryItem.displayValue);
					}, secondaryPgId: this.state.secondaryPgId, secondaryPgName: this.state.secondaryPgName, panelInfo: this.props.panelInfo }) : null
			);
		}
	}]);
...
SecondaryPage.propTypes = {
	secondaryItem: _propTypes2.default.object,
	secondaryRequestUrl: _propTypes2.default.string
};
...
var _CategoryContentItems = __webpack_require__(40);

var _CategoryContentItems2 = _interopRequireDefault(_CategoryContentItems);

var _SecondaryContentItems = __webpack_require__(43);

var _SecondaryContentItems2 = _interopRequireDefault(_SecondaryContentItems);
...
var SecondaryPageModal = createReactClass({
	displayName: 'SecondaryPageModal',
	...
	loadCategoryItems: function loadCategoryItems(contentItemId) {
	...
	render: function render() {
		...
		var nodes = secData.map(function (secondaryContentItem, index) {
			if (secondaryContentItem.contentType == 'Category') {
				hasCategory = true;
				return _react2.default.createElement(
					'li',
					{ key: "SecItem" + index, className: 'list-group-item' },
					_react2.default.createElement(_SecondaryContentItems2.default, { onClick: function onClick() {
							_this.loadCategoryItems(secondaryContentItem.contentItemId);
						}, secondaryContentItem: secondaryContentItem })
				);
			}
			return _react2.default.createElement(
				'li',
				{ key: "SecItem" + index, className: 'list-group-item' },
				_react2.default.createElement(_SecondaryContentItems2.default, { secondaryContentItem: secondaryContentItem })
			);
		});
		...
		if (hasCategory && catData.length > 0) {
			catNodes = catData.map(function (categoryContentItem, index) {
				return _react2.default.createElement(
					'li',
					{ key: "CatItem" + index, className: 'list-group-item' },
					_react2.default.createElement(_CategoryContentItems2.default, { categoryContentItem: categoryContentItem })
				);
			});
		}
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'button',
								{ type: 'button', className: 'close', 'data-dismiss': 'modal', onClick: this.props.onClose },
								'\xD7'
							),
							_react2.default.createElement(
								'ol',
								...
								_react2.default.createElement(
									'li',
									null,
									this.props.panelInfo.department
								)
							)
						),
						hasCategory ? _react2.default.createElement(
							'div',
							null,
							secHeader,
							_react2.default.createElement(
								'div',
								{ className: 'panel panel-default col-md-4' },
								_react2.default.createElement(
									'div',
									{ className: 'panel-body tab-pane' },
									_react2.default.createElement(
										'ul',
										{ className: 'list-group' },
										nodes
							...
							_react2.default.createElement(
								'div',
								{ className: 'panel panel-default col-md-7 col-md-offset-1' },
								_react2.default.createElement(
									'div',
									{ className: 'panel-body tab-pane' },
									_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'col-md-1 col-md-offset-10', style: clsBtnAlign },
								_react2.default.createElement(
									'button',
									{ id: 'close', type: 'button', className: 'aiBtn primaryBtn aiBtnSmall', onClick: this.props.onClose },
									'Close'
								)
							)
						) : _react2.default.createElement(
	...
	buildSinglePopUpHeader: function buildSinglePopUpHeader(title) {
		return _react2.default.createElement(
			'div',
			{ className: 'headerMainPanel' },
			_react2.default.createElement(
				'div',
				{ className: 'col-md-12 headerLeft text-center' },
				title
			)
		);
	},
	buildCategoryPopUpHeader: function buildCategoryPopUpHeader(title) {
		return _react2.default.createElement(
			'div',
			{ className: 'headerMainPanel' },
			_react2.default.createElement(
				'div',
				{ className: 'col-md-4 headerLeft text-center' },
				title
			),
			_react2.default.createElement(
				'div',
				{ className: 'col-md-7 text-center headerRight col-md-offset-1' },
				'Item'
			)
		);
	}
...
exports.default = SecondaryPageModal;
...
var CategoryContentItems = createReactClass({
	displayName: 'CategoryContentItems',
		...
		switch (catContentType) {
			case 'Uploaded Document':
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ target: this.defaultProps.newWin, href: this.defaultProps.vignetteUrl + categoryContentObj.url },
						categoryContentObj.displayValue
					)
				);
			case 'URL':
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ target: this.defaultProps.newWin, href: categoryContentObj.url },
						categoryContentObj.displayValue
					)
				);
			default:
...
exports.default = CategoryContentItems;
...
var SecondaryContentItems = createReactClass({
	displayName: 'SecondaryContentItems',
		...
		switch (secContentType) {
			case 'Uploaded Document':
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ target: this.props.newWin, href: this.props.vignetteUrl + secContentObj.url },
						secContentObj.displayValue
					)
				);
			case 'URL':
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ target: this.props.newWin, href: secContentObj.url },
						secContentObj.displayValue
					)
				);
			case 'Category':
				return _react2.default.createElement(
					'div',
					{ onClick: this.props.onClick.bind(this, secContentItemId) },
					_react2.default.createElement(
						'a',
						{ href: '#' },
						secContentObj.displayValue
			...
			default:
				/*return (<div>{secContentObj.displayValue}</div>);*/
				return null;
		}
	}
});
...
exports.default = SecondaryContentItems;
