...
jQuery(document).ready(function () {
	...
	$("#contentUploadStateId").on('change', function () {
		...
		if (contentType == 'Marketing' && selectedState == 'CT') {
			$('#contentUploadChannelId').prop('disabled', true).trigger('chosen:updated');
			$('#secLandingDDId').prop('disabled', true).trigger('chosen:updated');
			return;
		}
		...
		}).fail(function (jqXHR, textStatus) {}).always(function (jqXHR, textStatus) {
			$.unblockUI();
		});
	});
...
function updatePrimaryContentLandingPage() {
	...
	$.ajax({
		...
		timeout: 30000,
		cache: false
	}).done(function (response) {}).fail(function (jqXHR, textStatus) {}).always(function (jqXHR, textStatus) {
		$('#contentUploads').removeClass('hidden');
...
function displayPLPage(firstLevelContentsId, secLandingDDId, response) {
	...
	_reactDom2.default.render(_react2.default.createElement(PrimaryLandingTable, { cols: cols, data: $.parseJSON(primaryLandingList) }), document.getElementById('contentGridHeader'));
}
...
function displaySLPage(response) {
	if (response != null) {
		...
		if (NoData === undefined || NoData == "null" || typeof NoData == null) {
			...
			_reactDom2.default.render(_react2.default.createElement(SecondaryLandingTable, { cols: colsForSecPage, data: $.parseJSON(secondaryLandingList) }), document.getElementById('contentGridHeaderSecondary'));
		} else {
			var secondLevelContentsId = $('#secondLevelContents');
			secondLevelContentsId.append('<tr><td class="contentTD1">' + response.noData + '</td><td class="contentTD1">' + '<a id="addFirstPage" class="prmLinkRight">Add</a></td></tr>');
		}
	}
}

var PrimaryLandingTable = createReactClass({
	displayName: 'PrimaryLandingTable',
	...
	generateHeaders: function generateHeaders() {
		...
		return cols.map(function (colData) {
			if (colData.key == 'operatingCompanyCd') {
				return _react2.default.createElement(
					'th',
					{ style: thStyleForCompany, key: colData.key },
					' ',
					colData.label,
					' '
				);
				...
				return _react2.default.createElement(
					'th',
					{ style: thStyleForSecColumn, key: colData.key },
					' ',
					colData.label,
					' '
				);
				...
				return _react2.default.createElement(
					'th',
					{ style: thStyleForFirstAndLastColumn, key: colData.key },
					' ',
					colData.label,
					' '
				);
	...
	generateRows: function generateRows() {
		...
		function editPrimaryLandingPage(contentType, displayVal, operatingCompanyCd, url, contentItemId) {
			...
			} else if (chosenState == 'NJ' || chosenState == 'PA') {
		...
		function addNewContentItem(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder) {
			...
			$('#addContentTypePageId').val("Header").trigger('chosen:updated');
			...
			$('#operatingCompanyIdAdd').val(operatingCompanyCd).trigger('chosen:updated');
			operatingCompany.append('</option>');
		...
		return data.map(function (item) {
			...
			var cells = cols.map(function (colData) {
				if (colData.key == 'adminOperation') {
					if (contentTypeDeleteFlag == true) {
						return _react2.default.createElement(
							'td',
							{ style: tdStyleForAdminOperation },
							_react2.default.createElement(ContentAdminPageEdit, { edit: function edit() {
									return editPrimaryLandingPage(contentType, displayVal, operatingCompanyCd, url, contentItemId);
								} }),
							_react2.default.createElement(ContentAdminPageDelete, { del: function del() {
									return deletePrimaryLandingPage(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
								} }),
							_react2.default.createElement(ContentAdminPageArrowUp, { arrowUp: function arrowUp() {
									return arrowUpOperation(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
								} }),
							_react2.default.createElement(ContentAdminPageArrowDown, { arrowDown: function arrowDown() {
									return arrowDownOperation(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
								} }),
							_react2.default.createElement(ContentAdminPageAdd, { add: function add() {
									return addNewContentItem(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
								} })
						);
					} else {
						return _react2.default.createElement(
							...
							_react2.default.createElement(ContentAdminPageArrowUpWithoutDelete, { arrowUp: function arrowUp() {
									return arrowUpOperation(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
								} }),
							_react2.default.createElement(ContentAdminPageArrowDown, { arrowDown: function arrowDown() {
									return arrowDownOperation(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
					...
					if (item.contentType == 'Header') {
						...
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ target: '_blank', href: aiVignetteURL + url },
								item[colData.key]
							)
						);
					}
...
var SecondaryLandingTable = createReactClass({
	displayName: 'SecondaryLandingTable',
	...
	generateRows: function generateRows() {
		...
		function editSecondaryLandingPage(contentType, displayVal, operatingCompanyCd, url, contentItemId) {
			var chosenState = $("#contentUploadStateId").val();
			var selectedChannel = $("#contentUploadChannelId").val();
			var operatingCompany = $('#operatingCompanyIdEdit');
				...
				if (colData.key == 'adminOperation') {
					if (uploadDocumentFlag == true) {
						return _react2.default.createElement(
							...
							{ style: tdStyleForAdminOperation },
							_react2.default.createElement(ContentAdminPageEdit, { edit: function edit() {
									return editSecondaryLandingPage(contentType, displayVal, operatingCompanyCd, url, contentItemId);
								} }),
							_react2.default.createElement(ContentAdminPageDelete, { del: function del() {
									return deleteSecondaryLandingPage(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
								} }),
							_react2.default.createElement(ContentAdminPageArrowUp, { arrowUp: function arrowUp() {
									return arrowUpOperation(contentType, displayVal, operatingCompanyCd, url, contentItemId, pageId, displayOrder);
								} }),
...
var ContentAdminPageEdit = createReactClass({
	displayName: 'ContentAdminPageEdit',
	render: function render() {
		return _react2.default.createElement(
			'a',
			{ style: leftAligned, onClick: this.props.edit },
			'Edit'
		);
	}
});
...
var ContentAdminPageDelete = createReactClass({
	displayName: 'ContentAdminPageDelete',
	render: function render() {
		return _react2.default.createElement(
			'a',
			{ style: rightPadding, onClick: this.props.del },
			'Delete'
		);
	}
});
...
var ContentAdminPageArrowUp = createReactClass({
	displayName: 'ContentAdminPageArrowUp',
	render: function render() {
		return _react2.default.createElement(
			'a',
			{ style: rightPadding, onClick: this.props.arrowUp },
			_react2.default.createElement('img', { src: '../../aiui/resources/images/arrow_up_blue.png' })
		);
	}
});

var ContentAdminPageArrowDown = createReactClass({
	displayName: 'ContentAdminPageArrowDown',
	render: function render() {
		return _react2.default.createElement(
			'a',
			{ onClick: this.props.arrowDown },
			_react2.default.createElement('img', { src: '../../aiui/resources/images/arrow_down_blue.png' })
		);
	}
});

var ContentAdminPageArrowUpWithoutDelete = createReactClass({
	displayName: 'ContentAdminPageArrowUpWithoutDelete',
	render: function render() {
		return _react2.default.createElement(
			'a',
			{ style: rightPaddingWithoutDel, onClick: this.props.arrowUp },
			_react2.default.createElement('img', { src: '../../aiui/resources/images/arrow_up_blue.png' })
		);
	}
});
...
var ContentAdminPageAdd = createReactClass({
	displayName: 'ContentAdminPageAdd',
	render: function render() {
		return _react2.default.createElement(
			'a',
			{ style: rightAlignedforAdd, onClick: this.props.add },
			'Add'
		);
	}
});
