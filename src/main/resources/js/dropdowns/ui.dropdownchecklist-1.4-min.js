			...
			.widget(
					"ui.dropdownchecklist",
					{
						...
						_appendDropContainer : function(b) {
							...
							var c = a("<div/>");
							c
									.addClass("ui-dropdownchecklist-dropcontainer uiWidget-content");
						...
						_keyFocusChange : function(f, i, c, ctx) {
							var g = a(ctx).find(":focusable");
							var d = g.index(f);
							if (d >= 0) {
								d += i;
								if (c) {
						...
						_handleFocus : function(f, d, b) {
							...
							if (b && !c.dropWrapper.isOpen) {
								...
								if (d) {
									c.controlSelector
											.addClass("ui-dropdownchecklist-hover");
									...
									c.controlSelector
											.removeClass("ui-dropdownchecklist-hover")
								}
							} else {
								if (!b && !d) {
									if (f != null) {
						...
						_appendControl : function() {
							...
							var b = a("<span/>");
							b
									.addClass("ui-dropdownchecklist ui-dropdownchecklist-selector-wrapper uiWidget");
							b.css({
								display : "inline-block",
								cursor : "default",
								overflow : "hidden"
							});
							b.keydown(function(z) {
								if (z.keyCode == 40) {
							...
							var h = a("<span/>");
							h
									.addClass("ui-dropdownchecklist-selector ui-dropdownchecklist-default");
							h.css({
								display : "inline-block",
								overflow : "hidden",
								"white-space" : "nowrap"
							...
							var e = a("<span/>");
							e.addClass("ui-dropdownchecklist-headertext");
							e.css({
								display : "inline-block",
								"white-space" : "nowrap",
								overflow : "hidden"
							...
							b.hover(function() {
								if (!j.disabled) {
									h.addClass("ui-dropdownchecklist-hover")
								}
							}, function() {
								if (!j.disabled) {
									h.removeClass("ui-dropdownchecklist-hover")
								}
							});
							b
									.click(function(l) {
						...
						_createDropItem : function(g, f, o, l, q, h, e, k) {
							...
							t.addClass("ui-dropdownchecklist-default");
							if (e) {
								t.addClass("ui-dropdownchecklist-disabled")
							}
							i.click(function(u) {
							...
							t
									.hover(
											function(v) {
												var u = a(this);
												if (!u
														.hasClass("ui-dropdownchecklist-disabled")) {
													u
															.addClass("ui-dropdownchecklist-hover")
												}
											},
						...
						_createGroupItem : function(f, d) {
							...
							var e = a("<div />");
							e
									.addClass("ui-dropdownchecklist-group uiWidget-header");
							if (d) {
								e.addClass("ui-dropdownchecklist-disabled")
							}
							e.css({
								"white-space" : "nowrap"
							});
						...
						_createCloseItem : function(e) {
							...
							var d = a("<div />");
							d
									.addClass("ui-dropdownchecklist-default ui-dropdownchecklist-close ui-dropdownchecklist-item");
							d.css({
								"white-space" : "nowrap",
								"text-align" : "right"
							});
							...
							d.hover(function(f) {
								a(this).addClass("ui-dropdownchecklist-hover")
							}, function(f) {
								a(this).removeClass(
										"ui-dropdownchecklist-hover")
							});
						...
						_updateControlText : function() {
							...
							var e = f.find(".ui-dropdownchecklist-headertext");
							e.html(i);
							e.attr("title", e.text())
						},
						...
						_toggleDropContainer : function(e) {
							...
							var d = function(f) {
								if ((f != null) && f.dropWrapper.isOpen) {
									...
									g
											.removeClass("ui-dropdownchecklist-active");
									g.removeClass("ui-dropdownchecklist-hover");
									var j = f.controlWrapper.find(".uiIcon");
									if (j.length > 0) {
										j
							...
							var b = function(n) {
								if (!n.dropWrapper.isOpen) {
									...
									j.addClass("ui-dropdownchecklist-active");
									j.removeClass("ui-dropdownchecklist-hover");
									var h = n.controlWrapper.find(".uiIcon");
									if (h.length > 0) {
										h
						...
						_refreshOption : function(e, d, c) {
							...
							if (d) {
								...
								e.addClass("inactive");
								b.addClass("ui-dropdownchecklist-disabled")
							} else {
								e.prop("disabled", false);
								e.removeClass("inactive");
								e.addClass("active");
								b.removeClass(".ui-dropdownchecklist-disabled")
							}
							e.prop("checked", c)
						},
						_refreshGroup : function(c, b) {
							if (b) {
								c.addClass("ui-dropdownchecklist-disabled")
							} else {
								c.removeClass("ui-dropdownchecklist-disabled")
							}
						},
						close : function() {
						...
						enable : function() {
							this.controlSelector
									.removeClass("ui-dropdownchecklist-disabled");
							this.disabled = false
						},
						disable : function() {
							this.controlSelector
									.addClass("ui-dropdownchecklist-disabled");
							this.disabled = true
						},
						destroy : function() {
